...
('html', 3, 'Is the <!DOCTYPE html> tag considered as a HTML tag?', ' False'),

('javascript', 3, 'What is the difference between null and undefined?', ' absence of value, uninitialized variables'),
...
('react', 3, 'To link different pages in React, two components are needed:', 'Link and Route'),
('react', 3, 'Identify correct loop syntax used in Jsx', '{items.map(item => <SomeComponent key={item.id} />)}'),
...
('express', 3, 'Who was React developed by?', 'Facebook'),
('express', 3, 'Who was React developed by?', 'Facebook'),
('express', 3, 'Who was React developed by?', 'Facebook'),
('express', 3, 'Who was React developed by?', 'Facebook'),
('express', 3, 'Who was React developed by?', 'Facebook'),

('node', 3, '____is an advantage of using Node.js.', 'all of these'),
...
('node', 3, 'What are the most commonly used libraries in Node.js?', 'ExpressJS and Mongoose'),

('dsna', 3, 'Who was React developed by?', 'Facebook'),
('dsna', 3, 'Who was React developed by?', 'Facebook'),
('dsna', 3, 'Who was React developed by?', 'Facebook'),
('dsna', 3, 'Who was React developed by?', 'Facebook'),
('dsna', 3, 'Who was React developed by?', 'Facebook');
...
(79, 'Language dependent application programming', 'Hierarchy of objects in ASP.NET', 'Hierarchy of objects in ASP.NET', 'Convention for representing and interacting with objects in html documents'),
(80, 'True', 'False', '', ''),

(81, 'They are the same', 'uninitialized value, absence of value', 'absence of value, uninitialized variables', ' none of these'),
(82, 'true', 'false', '', ''),
(83, 'You should not use and or the JS reserved keywords as a variable name. (ie:boolean)', 'Variable names should not start with a numeral(0-9).They must begin with a letter or underscore.', 'All of these', 'Variable names are case sensitive.'),
(84, 'true', 'false', '', ''),
(85, 'var x = [];', 'var x = array;', ' var x = {};', 'none of these'),

(86, 'Link and Route', 'Router and Route', 'Switch and Route', ' Link and Router'),
(87, '{items.map(item => <SomeComponent key={item.id} />)}', 'for (let i=0; i <items.length; i++) {<SomeComponent key={items[i].id} />', 'for(let i=0; i < items, i++)', 'map => items(someComponent key=id)'),
(88, 'render () { return false }', 'render () { return null }', 'render () { }', 'render() { return <></> }'),
(89, 'static', 'alwaysSet()', ' immutable', ' doNotChange'),
(90, 'Field value persistence via Redux store', 'Validation (sync/async) and submission', 'Format, pare and normalize of field values', ' All of these'),

(91, 'asynchronous', ' unified programming language and data type', 'generally fast', ' all of these'),
(92, 'true', 'false', '', ''),
(93, 'Java', 'Python', 'Node.js', 'all of these'),
(94, 'true', 'false', '', ''),
(95, 'ExpressJS and Mongoose', 'ExpressJS and React', ' Mongoose and Angular', 'Java and ExpressJs'),

(96, 'props', 'genes', 'state', 'child'),
(97, 'props', 'genes', 'state', 'child'),
(98, 'props', 'genes', 'state', 'child'),
(99, 'props', 'genes', 'state', 'child'),
(100, 'props', 'genes', 'state', 'child'),

(101, 'props', 'genes', 'state', 'child'),
(102, 'props', 'genes', 'state', 'child'),
(103, 'props', 'genes', 'state', 'child'),
(104, 'props', 'genes', 'state', 'child'),
(105, 'props', 'genes', 'state', 'child');
