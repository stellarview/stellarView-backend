...
('express', 1, 'Which of the following commands is used to check the current version of NPM?', 'npm --version'),
('express', 1, 'Which of the following request methods is used to modify existing data?', 'PUT'),
('express', 1, 'Where are route parameters stored in the request object?', 'req.params'),
('express', 1, 'Express is a fast and minimalist web _________ for node.', 'framework'),
...
('dsna', 1, 'How could you describe an array?', 'container that stores elements'),
('dsna', 1, 'Which of the following is used to insert an element into a stack?', '.push()'),
('dsna', 1, 'When removing elements from a stack with .pop(), what is the order of removal?', 'elements are removed from the top'),
('dsna', 1, 'Which of the following data structures is linear?', 'all of these'),

('css', 2, 'How would you select the elements with the class name "example"?', '.example'),
...
('css', 2, 'Which of the following CSS properties defines the space between cells in a table?', 'border-spacing'),
('css', 2, 'Which of the following CSS properties controls how an element is positioned?', 'position'),
...
('express', 2, 'Which of these is a step in the implementation of error handling?', 'all answers are correct'),
('express', 2, 'Which of these arguments is available to a route handler function?', 'all of these'),
('express', 2, 'Express is written only in', 'JavaScript'),
...
('dsna', 2, 'The minimum number of stacks required to implement a queue is ____', '2'),
...
('express', 3, 'In Express there are two configuration properties: process.ENV and require(''config'').', 'true'),
('express', 3, 'What is the use of next()?', 'it passes management to the next middleware in the stack'),
('express', 3, 'Why do we use Express?', 'all of these'),
('express', 3, 'What does REST stand for?', 'REpresentational State Transfer'),
('express', 3, 'Which of these represents CRUD?', 'GET, POST, PUT, DELETE'), 
...
('dsna', 3, 'When provided to a function, what is .every() used for?', 'it checks if all array values pass a test'),
...
(32, 'shows a hierarchical structure', 'is immutable', 'container that stores elements', 'is not a data structure'),
(33, '.insert()', '.add()', '.push()', 'none of these'),
(34, 'elements are removed from the front', 'elements are removed randomly', 'elements are removed from the top', 'elements are removed from the bottom'),
...
(40, 'location', 'position', 'index', 'gps'),
...
(67, '1', '2', '3', '4'),
(68, '3', '1', '4', '2'),
(69, 'queue', 'dequeue', 'priority queue', 'circular queue'),
(70, 'O(1)', 'O(n)', 'O(logn)', 'O(nlogn)'),

(71, 'all of these', 'in-line', 'import', 'external style sheet'),
(72, 'true', 'false', '', ''),
(73, 'h2 & h3', 'h2 + h3', 'h2 h3', 'h2, h3'),
(74, 'element selector', 'class selector', 'universal selector', 'all of these'),
(75, 'true', 'false', '', ''),
...
(91, 'true', 'false', '', ''),
(92, 'it passes management to the next middleware in the stack', 'it represents the request and the response objects', 'it handles errors', 'none of these'),
(93, 'it creates faster and smarter web applications', 'it is simple and minimal', 'it is flexible and scalable', 'all of these'),
...
(104, 'it contains value pairs for every array value', 'it creates an array with sub-array elements concatenated', 'it checks if all array values pass a test', 'it is used in place of loops when iterating through an array'),
