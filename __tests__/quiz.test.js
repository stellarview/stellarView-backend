...
describe('quiz-routes', () => {
  ...
  it('should return the list of react level 3 questions', async () => {
    ...
    expect(res.body[0]).toEqual({
      ...
      choice_three: 'Switch',
      choice_four: 'Router',
      question: 'In React Router v6, which of these is deprecated?',
  ...
  it('should return the list of node level 2 questions', async () => {
    ...
    expect(res.body[0]).toEqual({
      ...
      choice_four: 'Curl.js',
      question: 'Which of the following frameworks is used majorly in Node.js?',
  ...
  it('should return the list of node level 3 questions', async () => {
    ...
    expect(res.body[0]).toEqual({
      ...
      question: '___is an advantage of using Node.js.',
      correct_answer: 'all of these',
    });
  });
